...
const Testimonial = () => {
    ...
    const CreateCard = ({ card }) => (
        <div className="p-4 glass-card rounded-lg mx-4 transition-all duration-200 w-72 shrink-0 border border-white/5">
            <div className="flex gap-2">
                <img className="size-11 rounded-full border border-white/10" src={card.image} alt="User Image" />
                <div className="flex flex-col">
                    <div className="flex items-center gap-1">
                        <p className="text-slate-200 font-medium">{card.name}</p>
                        <svg className="mt-0.5 fill-violet-400" width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <>
            <div id='testimonials' className='flex flex-col items-center my-10 scroll-mt-12 relative z-10'>
                <div className="flex items-center gap-2 text-sm text-violet-300 bg-violet-500/10 border border-violet-500/20 rounded-full px-6 py-1.5 mb-4">
                    <BookUserIcon className="size-4.5 stroke-violet-400" />
